...
def render_pagina(titulo_pagina, contenido_principal):
    ...
    <head>
        ...
        <style>
            ...
            * {{ box-sizing: border-box; margin: 0; padding: 0; font-family: 'Open Sans', sans-serif; }}
            ...
            .btn-primary {{ background: var(--primary); color: white; border: none; padding: 12px; border-radius: 6px; font-family: 'Montserrat', sans-serif; font-weight: 700; font-size: 14px; text-transform: uppercase; width: 100%; margin-top: 15px; cursor: pointer; transition: background 0.3s; }}
            .btn-primary:hover {{ background: #b80710; }}

            /* 5. SEO & Footer en la parte inferior */
    ...
    <body>
        ...
        <!-- 5. Pie de página con SEO Potente -->
        <footer>
...
# 3. Sobre Nosotros (Filtro Anti Fake News)
@app.route('/nosotros')
def nosotros():
    contenido = '''
    <div class="info-card">
...
# 2. Registro para Notificaciones
...
# 4. Donaciones para Sostener el Portal
...
def donaciones():
    ...
    <div class="info-card" style="text-align:center;">
        ...
        <div style="background:#f8f9fa; padding:20px; border-radius:8px; margin:20px 0; border:1px dashed #ccc;">
            <p style="font-weight:bold; color:#111; margin-bottom:10px;">Aportes a través de PayPal o Bizum:</p>
            <p style="color:var(--primary); font-weight:bold; font-size:16px;">donaciones@ultimominuto.com</p>
        </div>
        <button class="btn-primary" onclick="alert('¡Gracias por tu intención de apoyar a ÚLTIMOMINUTO!')">Hacer una Donación</button>
    </div>
    '''
