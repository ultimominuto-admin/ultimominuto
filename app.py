...
noticias = [
    {
        ...
        "categoria": "Fichajes",
        "imagen": "https://images.pexels.com/photos/46798/the-ball-stadion-football-the-pitch-46798.jpeg?auto=compress&cs=tinysrgb&w=800",
...
def home():
    html_noticias = ""
    default_img = "https://images.pexels.com/photos/46798/the-ball-stadion-football-the-pitch-46798.jpeg?auto=compress&cs=tinysrgb&w=800"
    
    for n in noticias:
        img_src = n.get("imagen") if n.get("imagen") and n.get("imagen").strip() else default_img
        
        html_noticias += f'''
        <div class="news-card">
            <img src="{img_src}" class="news-img" alt="Noticia" onerror="this.onerror=null; this.src='{default_img}';">
            <div class="news-body">
...
def donaciones():
    ...
    <div class="info-card" style="text-align:center;">
        ...
        <div style="background:#f8f9fa; padding:20px; border-radius:8px; margin:20px 0; border:1px dashed #ccc; text-align:left;">
            <p style="margin-bottom:8px;">📱 <strong>Bizum:</strong> <span style="color:var(--primary); font-weight:bold; font-size:16px;">632 413 171</span></p>
            <p>📧 <strong>PayPal / Email:</strong> <span style="color:var(--primary); font-weight:bold; font-size:15px;">donacionesultimominuto@gmail.com</span></p>
        </div>
...
def admin():
    ...
    <div class="info-card">
        ...
        <form method="POST">
            ...
            <label>URL de Imagen (Opcional - Si la dejas en blanco se pondrá una de fútbol automáticamente)</label>
...
def api_crear_noticia():
    ...
    if not data or data.get('api_key') != 'mi_clave_secreta_2026':
        return {"error": "No autorizado"}, 401
    
    nueva_noticia = {
        "id": len(noticias) + 1,
        "titulo": data.get("titulo"),
        "categoria": data.get("categoria", "Fútbol"),
        "imagen": data.get("imagen") if data.get("imagen") else "https://images.pexels.com/photos/46798/the-ball-stadion-football-the-pitch-46798.jpeg?auto=compress&cs=tinysrgb&w=800",
        "texto": data.get("texto"),
        "fecha": "2026-08-29"
    }
    
    noticias.insert(0, nueva_noticia)
    return {"status": "success", "mensaje": "Noticia publicada correctamente"}, 200
